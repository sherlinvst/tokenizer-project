...
public class TutPop extends Popup {
    ...
    private static final String[] MESSAGES = {
        ...
        "This is the Code Panel. Type or paste your source code here.  Below are buttons to get tokens, lexemes, and clear the panels.",
        "This is the Lexeme Panel. It displays the lexemes of your code.",
        "This is the Token Panel. It displays the tokens of your code.",
