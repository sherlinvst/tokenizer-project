...
public class ParserTest {
    public static void main(String[] args) {
        ...
        lines.add("class ErrorTest { int x = ; }");
        lines.add("class ErrorTest2 { public void test() { if (x > 0 { x++; } } }");
        lines.add("class ErrorTest3 { for (int i = 0; i < 10 i++) { x++; } }");
        lines.add("class ErrorTest4 { int y = (1 + 2; }");
